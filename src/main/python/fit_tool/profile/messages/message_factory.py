...
from fit_tool.profile.messages.device_aux_battery_info_message import (
    DeviceAuxBatteryInfoMessage,
)
...
from fit_tool.profile.messages.hsa_body_battery_data_message import (
    HsaBodyBatteryDataMessage,
)
from fit_tool.profile.messages.hsa_event_message import HsaEventMessage
from fit_tool.profile.messages.hsa_accelerometer_data_message import (
    HsaAccelerometerDataMessage,
)
...
from fit_tool.profile.messages.hsa_respiration_data_message import (
    HsaRespirationDataMessage,
)
from fit_tool.profile.messages.hsa_heart_rate_data_message import (
    HsaHeartRateDataMessage,
)
from fit_tool.profile.messages.hsa_configuration_data_message import (
    HsaConfigurationDataMessage,
)
from fit_tool.profile.messages.hsa_wrist_temperature_data_message import (
    HsaWristTemperatureDataMessage,
)
...
from fit_tool.profile.messages.chrono_shot_session_message import (
    ChronoShotSessionMessage,
)
...
from fit_tool.profile.messages.skin_temp_overnight_message import (
    SkinTempOvernightMessage,
)
...
class MessageFactory:
    ...
    def from_definition(
        ...
        if definition_message.global_id == FileIdMessage.ID:
            ...
            return DeviceAuxBatteryInfoMessage(
                definition_message=definition_message, developer_fields=developer_fields
            )
            ...
            return MonitoringHrDataMessage(
                definition_message=definition_message, developer_fields=developer_fields
            )

        elif definition_message.global_id == Spo2DataMessage.ID:
            return Spo2DataMessage(
                definition_message=definition_message, developer_fields=developer_fields
            )
            ...
            return AadAccelFeaturesMessage(
                definition_message=definition_message, developer_fields=developer_fields
            )

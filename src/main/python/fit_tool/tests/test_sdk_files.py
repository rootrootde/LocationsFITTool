...
class TestSdkFiles(unittest.TestCase):
    ...
    def test_activity_developer_data(self):
        """Test decoding activity file."""
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/activity_developerdata.fit"
        )
        ...
        out_path = os.path.join(
            os.path.dirname(__file__), "out/activity_developerdata.csv"
        )
        with open(out_path, "w", newline="") as csv_file:
            csv_writer = csv.writer(
                csv_file, delimiter=",", quotechar="|", quoting=csv.QUOTE_MINIMAL
    ...
    def test_activity_low_battery(self):
        ...
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/activity_lowbattery.fit"
        )
    ...
    def test_activity_multi_sport(self):
        ...
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/activity_multisport.fit"
        )
    ...
    def test_activity_poolswim_with_hr(self):
        """Test decoding"""
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/activity_poolswim_with_hr.fit"
        )
    ...
    def test_activity_truncated(self):
        """Test decoding"""
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/activity_truncated.fit"
        )
    ...
    def test_weight_scale_multi_user(self):
        """Test decoding"""
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/WeightScaleMultiUser.fit"
        )
    ...
    def test_weight_scale_single_user(self):
        """Test decoding"""
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/WeightScaleSingleUser.fit"
        )
    ...
    def test_workout_individual_steps(self):
        """Test decoding"""
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/WorkoutIndividualSteps.fit"
        )
    ...
    def test_workout_custom_target_values(self):
        """Test decoding"""
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/WorkoutCustomTargetValues.fit"
        )
    ...
    def test_workout_repeat_greater_than_step(self):
        """Test decoding"""
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/WorkoutRepeatGreaterThanStep.fit"
        )
    ...
    def test_workout_repeat_steps(self):
        ...
        path = os.path.join(
            os.path.dirname(__file__), "data/sdk/WorkoutRepeatSteps.fit"
        )

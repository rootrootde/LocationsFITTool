...
class TestRecord(unittest.TestCase):
    ...
    def test_normal_record_header(self):
        ...
        expected_rh = RecordHeader(
            is_definition=True, local_id=RecordHeader.MAX_NORMAL_LOCAL_ID
        )
    ...
    def test_compressed_timestamp_record_header(self):
        ...
        expected_rh = RecordHeader(
            is_time_compressed=True, local_id=3, time_offset_seconds=10
        )
    ...
    def test_record_pack_unpack(self):
        ...
        record2 = Record.from_bytes(
            definition_messages={local_id: definition_message}, bytes_buffer=bytes1
        )
